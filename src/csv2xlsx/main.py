...
``[options.entry_points]`` section in ``setup.cfg``::
    ...
    console_scripts =
         fibonacci = csv2xlsx.skeleton:run
...
__author__ = "Ray Hsieh"
__copyright__ = "Ray Hsieh"
__license__ = "MIT"
...
# `from csv2xlsx.skeleton import fib`,
...
def parse_args(args):
    ...
    parser.add_argument(
        "--version",
        action="version",
        version="csv2xlsx {ver}".format(ver=__version__),
    )
    parser.add_argument(
        "-i",
        "--input",
    ...
    parser.add_argument("-o", "--output", help="path to xlsx file", required=True)
